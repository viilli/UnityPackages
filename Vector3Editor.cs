...
public class Vector3Editor : EditorWindow
{
    ...
    // Checks for editing
    private static bool allowEditBySystem; // If GUI is setuped correcly
    private static bool allowEditByUser; // if user wants to edit
    ...
    private static void RepaintAll()
    {
        ...
        var windows = Resources.FindObjectsOfTypeAll<Vector3Editor>();
